---
title: Kubee - A One-Clik, Self-Hosted Kubernetes Platform
description: Manage a cluster
template: splash # Remove or comment out this line to display the site sidebar on this page.
hero:
  tagline: Kubernetes, the Easy way. Single VPS hosting and beyond.
  image:
    file: ../../assets/houston.webp
  actions:
    - text: Create your cluster
      link: /cluster-creation
      icon: right-arrow
      variant: minimal
---
