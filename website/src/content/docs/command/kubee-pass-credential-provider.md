---
title: kubectx-pass-credential-provider - provide client kubernetes credential from pass
---
...
An external
kube [credential provider](https://github.com/kubernetes/enhancements/blob/master/keps/sig-auth/541-external-credential-providers/README.md#provider-configuration)
based on [pass](https://www.passwordstore.org/)

See [kubeconfig-pass](../general/kubeconfig-pass.md) that explains how the connection information
...
You can set all driving environments variables defined in [kubee-env](../general/kubee-env.md).
